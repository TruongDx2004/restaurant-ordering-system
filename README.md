...
* Giao diện gọi món, theo dõi đơn hàng tối ưu UI/UX cho khách hàng

### IoT

* Thiết bị thông minh (ESP32-S3 N16R8)
...
* IoT: ESP32-S3 N16R8, Màn hình OLED (I2C), Module Microphone INMP441 (I2S), Module Amply MAX98357A (I2S), Loa (3W 4 Ohm), Cáp USB Type-C, Nút nhấn (Tactile Switch), Dây cắm (Jumper Wires).
